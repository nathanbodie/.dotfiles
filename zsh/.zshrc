...
PATH="/Users/nate/.cargo/bin:$PATH"
...
__conda_setup="$('/Users/nate/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/nate/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/nate/anaconda3/etc/profile.d/conda.sh"
    else
